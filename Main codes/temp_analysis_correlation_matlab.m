...
modelFormula=['PV_correlation~Time*NeuronCategory +PostS*NeuronCategory+REM*NeuronCategory' ...
...
dataTable = table(categorical(mouse(:)), ...
    categorical(postS(:)), categorical(REM(:)),categorical(neuronCategory(:)),C(:),recordingDay(:), ...
